...
/* Necesitamos una clase que separa la vista del modelo, 
 * en este caso (más adelante habrá más clases de separación), 
 * un controller que se encarga de atender las peticiones 
 * que vengan del navegador (cliente). Los controller:
 * 
...
public class ControladorSaludo {
	 ...
	 * 
	 * El @RequestParam se utiliza para pasar un parámetro a la petición tipo get, 
	 * es decir, información o datos que 
	 * vamos a pasar en una petición tipo get 
	 * (recuerda que no están pensadas para esto pero hay muchas veces
	 * en las que llevan algún parámetro).
	 * Si en la barra del navegador pasamos este parámetro 
	 * con un valor aparecerá en el saludo, esto es, 
	 * si escribes en el navegador http://localhost:9000/?nombre=Luis 
	 * aparecerá el saludo personalizado para Luis,
