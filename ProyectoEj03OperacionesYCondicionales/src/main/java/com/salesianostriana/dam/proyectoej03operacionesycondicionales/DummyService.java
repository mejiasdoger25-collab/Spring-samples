...
public class DummyService {
	...
	//Usamos el constructor que solo tiene 3 argumentos, escrito directamente en la 
	//clase Producto (no lo hace Lombok en este caso)
	...
	cuyo resultado devolviera un mapa con un elemento "encontrado", 
	solo el que estamos buscando	
	*/ 
